...
const BLOG = {
  ...
  SINCE: process.env.NEXT_SINCE || 1891, // e.g if leave this empty, current year will be used.
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '紅鏡公社', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个兴趣使然的「尾崎紅葉＆泉鏡花」 同人主页（測試中）', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'koyokyoka.prvcy.page', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'OZAKI KOYO ＆ IZUMI KYOKA', // 网站关键词 英文逗号隔开
  ...
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'KikukoNeko/NotionNext1', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
  COMMENT_GISCUS_REPO_ID: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO_ID || 'KoyoKyoka', // 你的Github Repo ID e.g ( 設定完 giscus 即可看到 )
  COMMENT_GISCUS_CATEGORY_ID:
    process.env.NEXT_PUBLIC_COMMENT_GISCUS_CATEGORY_ID || 'KoyoKyoka', // 你的Github Discussions 內的 Category ID ( 設定完 giscus 即可看到 )
  ...
  COMMENT_CUSDIS_APP_ID: process.env.NEXT_PUBLIC_COMMENT_CUSDIS_APP_ID || 'a241ebd9-faba-4e37-a661-22a693f00cd9', // data-app-id 36位 see https://cusdis.com/
  COMMENT_CUSDIS_HOST:
  ...
  COMMENT_VALINE_PLACEHOLDER:
    process.env.NEXT_PUBLIC_VALINE_PLACEHOLDER || '创作者留个反馈吧~', // 可以搭配后台管理评论 https://github.com/DesertsP/Valine-Admin  便于查看评论，以及邮件通知，垃圾评论过滤等功能
